...
import com.app.constants.TokenType;
...
public class JwtService {
  ...
  @Getter private final Long refreshTtlSeconds;
  ...
  public JwtService(
    ...
    if (secret == null || secret.length() < 64) {
      throw new IllegalStateException(
          "JWT secret must be at least 64 characters. Provide via env JWT_SECRET.");
    }
  ...
  public String generateAccessToken(User user) {
    ...
    return Jwts.builder()
        ...
        .addClaims(
            Map.of("email", user.getEmail(), "roles", roles, "type", TokenType.ACCESS.getType()))
  ...
  public boolean isAccessToken(String token) {
    ...
    return TokenType.ACCESS.getType().equals(c.get("type"));
  }

  public boolean isRefreshToken(String token) {
    Claims c = parse(token).getBody();
    return TokenType.REFRESH.getType().equals(c.get("type"));
  }
